...
public class DESUtil {
    ...
    static private class Base64Utils {
        ...
        static private byte[] decode(char[] data) {
            ...
            if (index != out.length) {
                throw new UnknownAccountException(String.valueOf(data));
            }
            return out;
        }
    }
    ...
    public static void main(String[] args) {
        try {
            String encryption = encryption("admin", "cdboost2018");
            String decryption = decryption("Fqc+l4/d2Jc=", "cdboost2018");
