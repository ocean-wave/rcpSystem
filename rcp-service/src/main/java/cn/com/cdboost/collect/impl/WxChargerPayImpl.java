...
//        }
    ...
    @Override
    @Transactional
    public void deductions(String chargingGuid, String deviceNo,String port,Integer openMeans,String openId,String priceId) {
        // 查询充电桩设备
        ...
        if(ChargeConstant.SchemePayCategory.TEMPORARY_RECHARGE.getType().equals(payCategory) || ChargeConstant.SchemePayCategory.RECHARGE_FULL.getType().equals(payCategory)){
            ...
            AccountOperateVo operateVo = AccountUtil.getAccountOperateVo(businessType, chargingPayCheme.getMoney());
            ...
            //包月用户扣除次数
            AccountOperateVo operateVo = AccountUtil.getAccountOperateVo(BusinessType.MONTH_CARD_CHARGE_SUCCESS, chargingPayCheme.getMoney());
            operateVo.setGuid(chargingGuid);
            operateVo.setAccountId(chargingCst.getId());
            ...
            updateParam.setRemainCnt(remainCnt);
            updateParam.setUpdateTime(new Date());
            chargingCstService.updateAccountNew(updateParam,operateVo);
    ...
    public Result withdrawCash(String guid,String openId, BigDecimal amount, HttpServletRequest request) {
        ...
        try {
            ...
            // 扣除用户账户余额,并记录账户流水
            AccountOperateVo operateVo = AccountUtil.getAccountOperateVo(BusinessType.WECHAT_WITHDRAW_CASH, amount);
...
//                    chargingWithdrawCashService.updateByPrimaryKeySelective(cashParam);
    ...
    private void doWechatError(ChargingCst chargingCst,String guid,BigDecimal amount, Integer id, String errorCode, String errorMsg) {
        AccountOperateVo operateVo = AccountUtil.getAccountOperateVo(BusinessType.WECHAT_WITHDRAW_CASH_REFUND, amount);
        operateVo.setGuid(guid);
        operateVo.setAccountId(chargingCst.getId());
    ...
    public Result alipayWithdrawCash(String guid, String alipayUserId, BigDecimal amount) {
        ...
        // 扣除用户账户余额,并记录账户流水
        AccountOperateVo operateVo = AccountUtil.getAccountOperateVo(BusinessType.ALIPAY_WITHDRAW_CASH, amount);
        operateVo.setGuid(guid);
        operateVo.setAccountId(chargingCst.getId());
    ...
    private void doAlipayError(ChargingCst chargingCst,String guid, BigDecimal amount, Integer id, String errorCode, String errorMsg) {
        AccountOperateVo operateVo = AccountUtil.getAccountOperateVo(BusinessType.ALIPAY_WITHDRAW_CASH_REFUND, amount);
        operateVo.setGuid(guid);
        operateVo.setAccountId(chargingCst.getId());
