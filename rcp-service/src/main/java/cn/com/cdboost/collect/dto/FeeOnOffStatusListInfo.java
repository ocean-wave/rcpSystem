 ...
 */
public class FeeOnOffStatusListInfo {
    /**
     * 状态
     */
     ...
     * 成功列表
     */
    private List<FeeOnOffInfo> successList;
     ...
     * 失败列表
     */
    private List<FeeOnOffInfo> failList;
    ...
    public List<FeeOnOffInfo> getSuccessList() {
        return successList;
    }

    public void setSuccessList(List<FeeOnOffInfo> successList) {
    ...
    public List<FeeOnOffInfo> getFailList() {
        return failList;
    }

    public void setFailList(List<FeeOnOffInfo> failList) {
