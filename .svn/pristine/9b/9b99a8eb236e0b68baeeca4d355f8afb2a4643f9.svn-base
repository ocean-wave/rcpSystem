...
public class ChargingDeviceServiceImpl extends BaseServiceImpl<ChargingDevice> implements ChargingDeviceService {
    ...
    public void addDevice(ChargingDevice chargingDevice, Integer userId) {
        ...
        //查询所有ic卡信息
        ChargerICCardQueryVo queryVo1 = new ChargerICCardQueryVo();
        queryVo1.setPageNumber(1);
        queryVo1.setPageSize(99999999);
        List<ChargingICCardDto> chargingICCardDtos = chargingCardMapper.queryList(queryVo1);
        //添加ic卡list表信息
        //TODO 设备编号暂时添加所有设备
        ...
        for (ChargingICCardDto chargingICCardDto : chargingICCardDtos) {
            ...
            chargingCardList.setCommNo(queryVo.getCommNo());
            chargingCardList.setDeviceNo(queryVo.getDeviceNo());
            chargingCardList.setCardId(chargingICCardDto.getCardId());
