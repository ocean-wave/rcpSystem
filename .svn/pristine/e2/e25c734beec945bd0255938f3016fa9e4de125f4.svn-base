...
public class TreeParser2 {
     ...
     * @return
     */
    public static <E extends TreeEntity2<E>> List<E> getTreeList(String topId, List<E> entityList) {
     ...
     * @return
     */
    private static <E extends TreeEntity2<E>>  List<E> getSubList(String id, List<E> entityList) {
