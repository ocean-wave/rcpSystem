package cn.com.cdboost.collect.advice;
...
public class CommonControllerAdvice {
    ...
    @ExceptionHandler(value = RcpDubboException.class)
    @ResponseBody
    public String RcpDubboExceptionHandler(RcpDubboException ex) {
        logger.error("dubbo调用异常：",ex);
        Result result = new Result();
        result.error(ex.getErrorMessage());
        return JSON.toJSONString(result);
    }
}
